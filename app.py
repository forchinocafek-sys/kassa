...
with tab1:
    ...
    with col_t2:
       ...
       # Создаем две колонки для Авансов и Кассы
    ...
    with col_bottom_2:
        st.subheader("💰 Крок 2: Рахунок готівки в касі")
        ...
        def cash_row_live(label, multiplier):
            ...
            with rc1:
                qty = get_int(st.text_input(f"{label} грн (шт):", value="0", key=f"qty_{label}_{selected_date}"))
            with rc2:
        ...
        v_20, v_50, v_100 = cash_row_live("20", 20), cash_row_live("50", 50), cash_row_live("100", 100)
        v_200, v_500, v_1000 = cash_row_live("200", 200), cash_row_live("500", 500), cash_row_live("1000", 1000)
